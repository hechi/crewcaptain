...
interface ActionItemRepository {
    ...
    fun findAllByUserIdAndPersonIdAndOriginatingEntryId(userId: UserId, personId: PersonId, originatingEntryId: OneOnOneEntryId, pageable: Pageable): Page<ActionItem>
