...
- [x] 1. Database migrations
  - [x] 1.1 Create Flyway migration for one_on_one_series table
  ...
  - [x] 1.2 Create Flyway migration for one_on_one_entries table
  ...
  - [x] 1.3 Create Flyway migration for agenda_items table
...
- [x] 2. Domain layer — Value Objects and Aggregates
  ...
  - [x] 2.2 Implement OneOnOneSeries aggregate root
  ...
  - [x] 2.3 Implement OneOnOneEntry aggregate root
  ...
  - [x] 2.6 Write property test: Custom cadence requires positive interval (Property 9)
  ...
  - [x] 2.7 Write property test: Agenda item text non-blank invariant (Property 8)
...
- [x] 3. Application layer — Use Cases and Ports
  ...
  - [x] 3.3 Implement OneOnOneService (all use cases)
  ...
  - [x] 3.4 Write use case unit tests with Mockk
...
- [x] 5. Persistence adapter
  ...
  - [x] 5.5 Write persistence integration tests with Testcontainers
...
- [x] 6. Web adapter — REST controller
  ...
  - [x] 6.5 Write property test: Authentication required on all 1:1 endpoints (Property 13)
...
- [x] 8. Integration tests — Full stack with security
  - [x] 8.1 Write data isolation integration test (Property 5)
  ...
  - [x] 8.2 Write pagination and ordering integration test (Properties 6, 7)
  ...
  - [x] 8.3 Write template prefill integration test (Properties 3, 4)
  ...
  - [x] 8.4 Write delete-then-retrieve integration test (Property 10)
    - Create an entry, delete it, verify GET returns 404
    - **Validates: Requirements 5.1, 5.4**

  - [x] 8.5 Write last 1:1 date integration test (Property 11)
  ...
  - [x] 8.6 Write sensitive flag integration test (Property 12)
...
- [x] 9. Checkpoint — Ensure all backend tests pass including integration
  - Run `cd api && ./gradlew test`
  - Ensure all tests pass, ask the user if questions arise.

- [x] 10. Frontend — Types and API client
  - [x] 10.1 Define TypeScript types
  ...
  - [x] 10.2 Implement API client functions
  ...
  - [x] 10.3 Write API client unit tests
...
- [x] 11. Frontend — Reusable components
  - [x] 11.1 Implement MarkdownEditor component
  ...
  - [x] 11.2 Implement AgendaItemList component
  ...
  - [x] 11.3 Implement OneOnOneEntryCard component
  ...
  - [x] 11.4 Implement OneOnOneTimeline component
  ...
  - [x] 11.5 Implement OneOnOneEntryForm component
  ...
  - [x] 11.6 Implement SeriesConfigPanel component
  ...
  - [x] 11.7 Implement SensitiveToggle and SensitiveBadge components
  ...
  - [x] 11.8 Write component unit tests
...
- [x] 12. Frontend — Pages
  - [x] 12.1 Update Person Detail page — add 1:1s tab
  ...
  - [x] 12.2 Implement Create Entry page (/people/[id]/one-on-ones/new)
  ...
  - [x] 12.3 Implement Entry Detail/Edit page (/people/[id]/one-on-ones/[entryId])
    - Fetch and display full entry
    - OneOnOneEntryForm in edit mode
    - Delete button with confirmation
    - _Requirements: 13.6, 14.4_

  - [x] 12.4 Write page integration tests
